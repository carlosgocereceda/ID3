...
public class Tutorial1 extends JFrame 
	implements GInteraction
	{
	  ...
	  public Tutorial1(ArrayList<Nodo> arbol)
	  {
	    ...
	    GObject object1 = new TestObject (arbol.get(0).getAtributo(), scene_,  1000.0, 100.0);
	    for(int i = 0; i < arbol.size(); i++) {
	    	
	    }
	    
	    /*GObject object1 = new TestObject ("1", scene_,  1000.0, 100.0);

	    GObject object2  = new TestObject ("2",  object1, 500.0, 250.0);
	    GObject object3  = new TestObject ("3",  object1, 500.0, 250.0);
	    GObject object4  = new TestObject ("4",  object1, 500.0, 250.0);
